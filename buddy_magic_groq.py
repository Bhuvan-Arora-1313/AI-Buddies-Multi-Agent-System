import time
import json
from buddies.swe_buddy_groq import SWEbuddyGroq
from buddies.pa_buddy_groq import PersonalAssistantBuddyGroq
...
def run_buddy_system():
    pab = PersonalAssistantBuddyGroq()
    swe = SWEbuddyGroq()
